...
async function assignPageToBusinessManager(
  ...
  try {
    console.log(
      pageAccessToken,
      "Assigning page to Business Manager...",
      metaManagerId,
    );
    const { data } = await axios.get(
      `https://graph.facebook.com/v21.0/${metaManagerId}/client_pages`,
      {
        params: {
          access_token:
            "EAAJeydN1ENwBPucUNrYCW144k4dv0ceyeaact0hVgUq0wRQ4GAHimXYj4ZA2N7zx3zlW2qBlncfz0YGJgiPkh3MWixZBOG2bfjV0XA80gJT6HZBeuUqTltemoj3DOGKzgZA3uTaBdaAUG96eTaTmmIWeOJjabusjd9WZBUuIC5NELcuDdXnlaVjPN11Eu6QLl4QZDZD",
        },
      },
    );
  ...
  try {
    await axios.post(
      `https://graph.facebook.com/v21.0/${pageId}/assigned_users`,
      {
        ...
        business: process.env.businessId,
        access_token:
          process.env.systemUserAccessToken ||
